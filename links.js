...
const linkData = [
    ...
    },
    {
        ...
        links: [
            ...
            { name: "刑事政策與犯罪(專刊)", url: "https://www.cprc.moj.gov.tw/1563/1590/1591/Lpsimplelist", icon: "fa-solid fa-user-secret" },
            ...
            { name: "台灣碩博士論文", url: "https://ndltd.ncl.edu.tw/cgi-bin/gs32/gsweb.cgi/login?o=dwebmge", icon: "fa-solid fa-file-pdf" },
             { name: "最高檢察署月刊", url: "https://www.tps.moj.gov.tw/16314/1042381/Lpsimplelist", icon: "fa-solid fa-gavel" },
    { name: "立法院議題研析", url: "https://www.ly.gov.tw/Pages/List.aspx?nodeid=46869", icon: "fa-solid fa-landmark" },
    { name: "臺大法學評論", url: "https://toaj.stpi.niar.org.tw/index/journal/4b1141f97ce46933017ce469b62b0028", icon: "fa-solid fa-building-columns" },
    { name: "高大法學論叢", url: "https://rlawyuan.nuk.edu.tw/p/412-1031-5227.php?Lang=zh-tw", icon: "fa-solid fa-building-columns" },
    { name: "成大法學", url: "https://toaj.stpi.niar.org.tw/index/journal/4b1141f985befdce0185c30718ec00cf", icon: "fa-solid fa-building-columns" },
    { name: "政大法學評論", url: "http://review.law.nccu.edu.tw/zh_tw/articles", icon: "fa-solid fa-building-columns" },
    { name: "刑事政策與犯罪(論文)", url: "https://www.cprc.moj.gov.tw/1563/1590/1593/Lpsimplelist", icon: "fa-solid fa-fingerprint" },
    { name: "法制史研究", url: "http://www.clegalhistory.org/index.php?action=legal-history-research_in&id=42", icon: "fa-solid fa-scroll" },
    { name: "最高法院裁判書彙編", url: "https://tps.judicial.gov.tw/tw/np-10662-011.html", icon: "fa-solid fa-scale-balanced" },
        ]
    },
    {
        groupName: "第四群組：線上課程",
        links: [
            ...
            { name: "勞動力發展數位服務平台", url: "https://portal.wda.gov.tw/resource/type/0", icon: "fa-solid fa-network-wired" },
    { name: "udemy", url: "https://www.udemy.com/", icon: "fa-solid fa-graduation-cap" },
    { name: "coursera", url: "https://www.coursera.org/", icon: "fa-solid fa-building-columns" },
    { name: "hahow", url: "https://hahow.in/", icon: "fa-solid fa-school" },
    { name: "PressPlay Academy", url: "https://www.pressplay.cc/", icon: "fa-solid fa-circle-play" },
    { name: "YOTTa", url: "https://www.yottau.com.tw/home", icon: "fa-solid fa-chalkboard-user" },
    { name: "TibaMe", url: "https://www.tibame.com/", icon: "fa-solid fa-laptop-code" },
    { name: "SAT. KNOWLEDGE", url: "https://sat.cool/home", icon: "fa-solid fa-brain" },
    { name: "TaiwanLife", url: "https://taiwanlife.org/?redirect=0", icon: "fa-solid fa-book-open-reader" },
    { name: "均一教育平台", url: "https://www.junyiacademy.org/", icon: "fa-solid fa-scale-balanced" },
